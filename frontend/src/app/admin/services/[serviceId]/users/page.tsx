        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <header className="bg-white border-b border-gray-200 px-8 py-4">
                    ...
                    <p className="text-sm text-gray-500">Agents, administrateurs et permissions</p>
                </header>
                ...
                <main className="flex-1 overflow-y-auto p-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-12 text-center">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Gestion des Utilisateurs</h3>
                            <p className="text-gray-500 mb-6">
                                Gérez les agents, leurs rôles, permissions et assignations aux guichets.
                            </p>
